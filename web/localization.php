...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Start vanaf huidige saldo: + geplande termijnfacturen, − basislijnkosten (lineair over projectperiode).',
    ...
    'en' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Starts from the current balance: + planned installments, − baseline costs (linear over the project period).',
    ...
    'de' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Startet beim aktuellen Saldo: + geplante Raten, − Baseline-Kosten (linear über die Projektlaufzeit).',
    ...
    'fr' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Part du solde actuel : + acomptes planifiés, − coûts baseline (linéaire sur la durée du projet).',
