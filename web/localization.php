...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moneta.section.history' => 'Bankhistorie',
        ...
        'moneta.chart.forecast_title' => 'Prognose banksaldi',
        'moneta.chart.forecast_subtitle' => 'Start vanaf het huidige saldo, plus geplande termijnfacturen van open projecten.',
        'moneta.chart.forecast_link_note' => 'Koppeling factuur→rekening: eerst Company_Bank_Account_Code via documentnummer, anders valuta-match (hoogste saldo per valuta). Ontbrekende matches komen in “Niet toegewezen”.',
        'moneta.chart.forecast_meta' => '%d geplande termijnen in periode (%d niet toegewezen).',
    ...
    'en' => [
        ...
        'moneta.section.history' => 'Bank history',
        ...
        'moneta.chart.forecast_title' => 'Bank balance forecast',
        'moneta.chart.forecast_subtitle' => 'Starts from the current balance, plus planned installments from open projects.',
        'moneta.chart.forecast_link_note' => 'Invoice→account link: first Company_Bank_Account_Code via document number, otherwise currency match (highest balance per currency). Unmatched items go to “Unassigned”.',
        'moneta.chart.forecast_meta' => '%d planned installments in period (%d unassigned).',
    ...
    'de' => [
        ...
        'moneta.chart.forecast_title' => 'Banksaldo-Prognose',
        'moneta.chart.forecast_subtitle' => 'Startet beim aktuellen Saldo plus geplante Raten offener Projekte.',
        'moneta.chart.forecast_link_note' => 'Rechnung→Konto: zuerst Company_Bank_Account_Code über Belegnummer, sonst Währungsabgleich (höchster Saldo je Währung). Ohne Match → „Nicht zugewiesen“.',
        'moneta.chart.forecast_meta' => '%d geplante Raten im Zeitraum (%d nicht zugewiesen).',
    ...
    'fr' => [
        ...
        'moneta.section.history' => 'Historique bancaire',
        ...
        'moneta.chart.forecast_subtitle' => 'Part du solde actuel, plus acomptes planifiés des projets ouverts.',
        'moneta.chart.forecast_link_note' => 'Lien facture→compte : d’abord Company_Bank_Account_Code via n° document, sinon devise (solde le plus élevé). Sinon → « Non attribué ».',
        'moneta.chart.forecast_meta' => '%d acomptes planifiés sur la période (%d non attribués).',
