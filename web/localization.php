...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Start vanaf groepssaldi: + geplande termijnfacturen, − basislijnkosten (lineair over projectperiode).',
        'moneta.chart.forecast_link_note' => 'Opbrengst: documentbank of valuta-match. Kosten: voorcalculatie (JobBaselineLines) minus geboekte kosten (JobLedgerEntries); periode = max(projectstart, vandaag) t/m projecteinde.',
        ...
        'moneta.picker.subtitle' => 'Kies een rekening uit het Rekeningschema (G_L_Account).',
    ...
    'en' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Starts from group balances: + planned installments, − baseline costs (linear over the project period).',
        'moneta.chart.forecast_link_note' => 'Revenue: document bank or currency match. Costs: baseline (JobBaselineLines) minus booked costs (JobLedgerEntries); period = max(project start, today) through project end.',
        ...
        'moneta.picker.subtitle' => 'Pick an account from the chart of accounts (G_L_Account).',
    ...
    'de' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Startet bei Gruppensalden: + geplante Raten, − Baseline-Kosten (linear über die Projektlaufzeit).',
        'moneta.chart.forecast_link_note' => 'Erlöse: Belegbank oder Währungsabgleich. Kosten: Baseline (JobBaselineLines) minus gebuchte Kosten (JobLedgerEntries); Periode = max(Projektstart, heute) bis Projektende.',
        ...
        'moneta.picker.subtitle' => 'Wählen Sie ein Konto aus dem Kontenplan (G_L_Account).',
    ...
    'fr' => [
        ...
        'moneta.chart.forecast_subtitle' => 'Part des soldes de groupe : + acomptes planifiés, − coûts baseline (linéaire sur la durée du projet).',
        'moneta.chart.forecast_link_note' => 'Produits : banque document ou devise. Coûts : baseline (JobBaselineLines) moins coûts comptabilisés (JobLedgerEntries) ; période = max(début projet, aujourd’hui) → fin projet.',
        ...
        'moneta.picker.subtitle' => 'Choisissez un compte du plan comptable (G_L_Account).',
