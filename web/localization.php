...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moneta.derived.subtitle' => 'Kies groepen en een bewerking. Met “=” wordt alleen de linker groep getoond.',
        ...
        'moneta.lines.title' => 'Horizontale lijnen',
        'moneta.lines.subtitle' => 'Referentielijnen op een vast bedrag. Alleen zichtbaar als dat bedrag in de grafiekrange valt.',
        'moneta.lines.add' => 'Lijn toevoegen',
        'moneta.lines.remove' => 'Lijn verwijderen',
        'moneta.lines.name' => 'Naam',
        'moneta.lines.color' => 'Kleur',
        'moneta.lines.amount' => 'Bedrag',
        'moneta.lines.default_name' => 'Nieuwe lijn',
        'moneta.lines.empty' => 'Nog geen horizontale lijnen.',
    ...
    'en' => [
        ...
        'moneta.derived.subtitle' => 'Pick groups and an operator. “=” shows only the left group as-is.',
        ...
        'moneta.lines.title' => 'Horizontal lines',
        'moneta.lines.subtitle' => 'Reference lines at a fixed amount. Shown only if that amount is in the visible range.',
        'moneta.lines.add' => 'Add line',
        'moneta.lines.remove' => 'Remove line',
        'moneta.lines.name' => 'Name',
        'moneta.lines.color' => 'Color',
        'moneta.lines.amount' => 'Amount',
        'moneta.lines.default_name' => 'New line',
        'moneta.lines.empty' => 'No horizontal lines yet.',
    ...
    'de' => [
        ...
        'moneta.derived.subtitle' => 'Wählen Sie Gruppen und eine Operation. „=“ zeigt nur die linke Gruppe unverändert.',
        ...
        'moneta.lines.title' => 'Horizontale Linien',
        'moneta.lines.subtitle' => 'Referenzlinien bei einem festen Betrag. Nur sichtbar, wenn der Betrag im dargestellten Bereich liegt.',
        'moneta.lines.add' => 'Linie hinzufügen',
        'moneta.lines.remove' => 'Linie entfernen',
        'moneta.lines.name' => 'Name',
        'moneta.lines.color' => 'Farbe',
        'moneta.lines.amount' => 'Betrag',
        'moneta.lines.default_name' => 'Neue Linie',
        'moneta.lines.empty' => 'Noch keine horizontalen Linien.',
        'moneta.forecast.title' => 'Prognose',
    ...
    'fr' => [
        ...
        'moneta.derived.subtitle' => 'Choisissez des groupes et une opération. « = » affiche uniquement le groupe de gauche tel quel.',
        ...
        'moneta.lines.title' => 'Lignes horizontales',
        'moneta.lines.subtitle' => 'Lignes de référence à un montant fixe. Visibles seulement si ce montant est dans la plage affichée.',
        'moneta.lines.add' => 'Ajouter une ligne',
        'moneta.lines.remove' => 'Supprimer la ligne',
        'moneta.lines.name' => 'Nom',
        'moneta.lines.color' => 'Couleur',
        'moneta.lines.amount' => 'Montant',
        'moneta.lines.default_name' => 'Nouvelle ligne',
        'moneta.lines.empty' => 'Aucune ligne horizontale.',
