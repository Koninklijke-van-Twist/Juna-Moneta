...
const TRANSLATIONS = [
    'nl' => [
        ...
        'moneta.chart.forecast_link_note' => 'Opbrengst: documentbank of valuta-match. Kosten via JobBaselineLines (valuta-match); periode = max(projectstart, vandaag) t/m projecteinde.',
    ...
    'en' => [
        ...
        'moneta.chart.forecast_link_note' => 'Revenue: document bank or currency match. Costs via JobBaselineLines (currency match); period = max(project start, today) through project end.',
    ...
    'de' => [
        ...
        'moneta.chart.forecast_link_note' => 'Erlöse: Belegbank oder Währungsabgleich. Kosten über JobBaselineLines (Währung); Periode = max(Projektstart, heute) bis Projektende.',
    ...
    'fr' => [
        ...
        'moneta.chart.forecast_link_note' => 'Produits : banque document ou devise. Coûts via JobBaselineLines (devise) ; période = max(début projet, aujourd’hui) → fin projet.',
